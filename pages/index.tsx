...
const App: NextPage = () => (
    <div className={`global-font ${ocra.variable} font-sans w-full h-screen p-16 flex flex-col justify-between`}>
        <Title />
        {/* <ResponsiveDrawer /> */}
        <div className='flex flex-row justify-between items-center'>
            <div className='flex flex-row justify-between items-center self-start gap-5 w-96'>
            ...
            <a href="mailto:laijackylai@gmail.com" className="border border-black p-2 rounded-full relative overflow-hidden group">
        ...
        <div className='col-span-5 flex flex-col items-end justify-end gap-14'>
            <div className="flex flex-col text-8xl font-['Sabon'] p-2 text-end font-bold">
                <div>Full Stack</div>
                <div>Software Engineer</div>
            </div>
            <div className='text-lg text-right w-1/3'>
